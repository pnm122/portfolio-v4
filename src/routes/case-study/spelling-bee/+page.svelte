...
<main class="case-study">
  ...
  <section class="section">
    <h2 class="section__title">Finished Product</h2>
    <div class="section__text">
      <p>
  ...
  <section class="section">
    ...
    <div class="section__text">
      <p>
        Because I spent a lot of time working with tools that were new to me, my biggest insight was creating a working knowledge with these tools. This project also gives me a foundation to start from for any future project that I want to use Svelte, Node+Express, or MongoDB for. These tools also don’t exist in a vacuum—many concepts I tackled are applicable to other frameworks and tools.
      </p>
      <p>
